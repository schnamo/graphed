      ...
      api.createNote(workspace_id, "tada", function(note2) {
        ...
        api.createNote(workspace_id, "tralala", function(note3){
          ...
          api.connectNotes(workspace_id, note1.id, note2.id, function(connection) {
            ...
            api.createWorkspace("just_another_workspace", function(workspace_2) {
              console.log(workspace_2);
                api.getWorkspaces(function(workspaceStuff) {
                  console.log(workspaceStuff);
                  api.renameWorkspace(workspace_id, "very_new_workspace_name", function(newNote) {
                    console.log(newNote);
                    api.getWorkspaces(function(workspaceStuff2) {
